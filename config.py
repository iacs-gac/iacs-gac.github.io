...
SITEURL = 'https://iacs-gac.github.io/'

GITHUB = 'https://github.com/iacs-gac/'
...
IGNORE_FILES = ['.#*', '.ipynb_checkpoints', 'README.md', "__pycache__", "*.pdf", "*.pptx", ".placeholder", ".DS_Store", "*.ipynb-meta", "*.csv", "*.json", "*.txt", "*.xmls"]
